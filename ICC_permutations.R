# the function takes a dataframe suitable for icc calculation (e.g., columns = raters, rows = subjects)
# uses the following packages: tidyverse, irr
...
# permu_df(df, 3) ## every possible permutation of three
